  ...
  "flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 bg-background text-xs font-medium",
  {
    variants: {
      status: {
        ...
        completed: "border-red-500 bg-red-500 text-primary-foreground",
        active: "border-red-500 bg-background text-red-500 animate-pulse",
...
export function UGKTEDTimeline() {
  const items: TimelineItem[] = [
    {
      id: "1",
      title: "UGKTED'in Kuruluşu",
      description:
        "Uluslararası Girişimci Kültür Turizm ve Eğitim Derneği (UGKTED), girişimcilik ruhunu kültür, turizm ve eğitim alanlarında uluslararası düzeyde yaygınlaştırmak amacıyla kuruldu. Dernek, yenilikçi düşünceyi, kültürel çeşitliliği ve sürdürülebilir gelişimi destekleyerek bireylerin ve toplumların potansiyelini ortaya çıkarmayı hedefledi.",
      timestamp: new Date("2020-01-01"),
      status: "completed",
    },
    {
      id: "2",
      title: "İlk Uluslararası Projeler",
      description:
        "Dernek, farklı ülkelerden girişimciler, akademisyenler, sanatçılar ve genç liderleri bir araya getirerek ilk uluslararası projelerini hayata geçirdi. Bilgi paylaşımı ve ortak projeler aracılığıyla kültürel köprüler kurulmaya başlandı.",
      timestamp: new Date("2021-01-01"),
      status: "completed",
    },
    {
      id: "3",
      title: "Eğitim Programları ve Seminerler",
      description:
        "UGKTED, uluslararası seminerler ve eğitim programları düzenleyerek girişimcilik ekosistemine katkı sağlamaya başladı. 'Birlikte üretmek, paylaşmak ve gelişmek' ilkesiyle hareket eden dernek, toplumsal faydayı ön planda tuttu.",
      timestamp: new Date("2022-01-01"),
      status: "completed",
    },
    {
      id: "4",
      title: "Kültürel Organizasyonlar ve Etkinlikler",
      description:
        "Dernek, kültürel organizasyonlar ve etkinlikler düzenleyerek farklı kültürler arasında diyalog ve iş birliğini güçlendirdi. Girişimcilik vizyonunu kültürel çeşitlilikle harmanlayarak zengin bir ekosistem oluşturdu.",
      timestamp: new Date("2023-01-01"),
      status: "completed",
    },
    {
      id: "5",
      title: "Genişleyen Ağ ve Ortaklıklar",
      description:
        "UGKTED, uluslararası ağını genişleterek daha fazla ülke ve kuruluşla ortaklıklar kurdu. Girişimcilik, kültür, turizm ve eğitim alanlarında sürdürülebilir projeler geliştirerek toplumsal etkisini artırdı.",
      timestamp: new Date("2024-01-01"),
      status: "active",
    },
    {
      id: "6",
      title: "Dijital Dönüşüm ve Gelecek Vizyonu",
      description:
        "Dernek, dijital dönüşüm sürecini hızlandırarak online platformlar ve dijital araçlarla daha geniş kitlelere ulaşmaya başladı. Gelecek vizyonuyla, girişimcilik ekosisteminde öncü bir rol üstlenmeye devam ediyor.",
  ...
  return (
    <section className="bg-background py-5 w-full overflow-hidden">
