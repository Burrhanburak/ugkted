    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                {/* Icon */}
                <div className="w-[34px] h-[34px] bg-red-500 rounded-full flex items-center justify-center flex-shrink-0 transition-transform duration-200 ease-out hover:scale-105">
    ...
    const faqs = [
        {
            ...
            answer: "Türkiye Merkezli Uluslararası Girişimci Kültür Turizm ve Eğitim Derneği (UGKTED), girişimcilerin, akademisyenlerin ve genç liderlerin bir araya gelerek oluşturduğu gönüllü bir sivil toplum kuruluşudur. Girişimcilik, kültür, turizm ve eğitim alanlarında uluslararası iş birlikleri geliştirir."
        },
        {
        ...
        >
            <div className="flex flex-col items-center justify-center gap-[60px] w-full max-w-[1200px]">
                ...
                <div className="flex flex-col items-center justify-start gap-5 w-full max-w-[540px]">
                    <h2 className="text-center font-bold text-[rgba(255, 0, 0, 1)] text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-tight">
                        Sıkça Sorulan Sorular
                    </h2>
                    <p className="text-center text-[rgba(250, 23, 23, 1)] text-base md:text-lg leading-relaxed opacity-80">
